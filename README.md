...
1. Plug the ultrasonic sensor into port `D4` on the shield, and plug the servo into port `D8`.
1. Upload the `./main/main.ino` file onto your Arduino from within the Arduino IDE.
